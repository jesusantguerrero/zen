<template>
    <div class="flex items-center justify-center tag-select">
        <el-popover
            ...
            :width="240"
            :show-arrow="false"
            @hide="state.selectedItem=null"
            @after-enter="focusInput()"
        >

            <div v-if="state.selectedItem">
                <div class="flex items-center mb-5">
                    <button @click="state.selectedItem = null" class="px-2 py-1 rounded-md hover:bg-gray-200 focus:outline-none"><i class="fa fa-chevron-left"></i></button>
                ...
                <div class="mb-6 text-left">
                    ...
                    <input
                        ...
                        v-model.trim="state.selectedItem.name"
                        ref="input"
                    />
                </div>
                ...
                <div class="mt-2">
                     ...
                     <div class="grid grid-cols-4">
                        <div v-for="colors in state.tagColors" 
                            ...
                            :class="[`border-2 border-transparent ${colors.hover}`, state.selectedItem.colors && state.selectedItem.colors[0] == colors[0] && 'border-gray-600' ]"
                            @click="state.selectedItem.colors=colors"
                        >
            ...
            <div class="w-full px-1 pt-2 pb-5" v-else>
                ...
                <div 
                    ...
                    >
                        ...
                        <div @click.prevent.stop="state.selectedItem=tag" class="flex items-center justify-center w-10 px-2 py-1 transition-colors rounded-full hover:bg-gray-700 hover:text-white">
...
const isSelected = (uid) => {
    return selectedItems.value.find( tag => tag.uid == uid)
}
