      ...
      <template #body>
          ...
          >   
              <div class="flex justify-between">
                  ...
                  <div class="flex items-center text-sm task-item__controls" v-if="!isReminder">
                      <div class="w-24 mx-2 text-gray-400 hover:text-gray-600">
                      <date-select 
...
<script setup>
import { defineProps, ref, watch, computed, reactive, toRefs } from "vue"
