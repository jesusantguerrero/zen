    ...
    >
      <div class="flex items-baseline">
        ...
        <div class="hidden md:flex md:items-center md:ml-4" v-if="user">
          <!-- <menu-item class="pl-2 mx-2" to="/home"> Home </menu-item> -->
          <menu-item class="pl-2 mx-2" to="/zenboard">Zenboard </menu-item>
          <menu-item class="px-2 ml-2" to="/standup">Stand Up</menu-item>
          <menu-item class="px-2 mx-2" to="/matrix">Matrix</menu-item>
          <menu-item class="px-2 mx-2" to="/metrics">Metrics</menu-item>
        </div>
      </div>
      ...
      <div class="hidden md:flex md:items-center" v-if="user">
        ...
        <router-link 
          to="/plan-ahead" 
          class="hidden px-5 py-1 mr-2 text-white bg-green-500 rounded-md lg:inline-block ring ring-green-400 dark:ring-green-600 ring-offset-0 dark:bg-green-700 hover:bg-green-400 dark:hover:bg-green-800">
