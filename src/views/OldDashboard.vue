      ...
      >
        <header class="flex justify-between">
          <h1 class="md:block text-2xl font-bold text-gray-400">
            Main Task
            <button class="text-sm bg-white p-2 rounded-md"
              v-if="true"
          ...
          <time-tracker :task="currentTask" v-model:currentTimer="currentTimer" size="mini">
          </time-tracker>
        </header>
...
import TimeTracker from "../components/organisms/TimeTrackerWrapper.vue";
