        ...
        <div class="mx-auto max-w-7xl z-50">
            ...
            <div class="container py-32 mx-auto text-center sm:px-4 z-50">
                ...
                <div class="relative flex items-center max-w-md mx-auto mt-12 text-center">
                    <input type="text" name="email" placeholder="Email Address" class="w-full h-12 px-6 py-2 font-medium text-green-800 rounded-l-full focus:outline-none">
                    <span class="relative top-0 right-0 block rounded-full shadow-sm">
                        <button type="button" class="inline-flex items-center w-32 h-12 px-8 text-base font-bold leading-6 text-white transition duration-150 ease-in-out bg-green-400 border border-transparent rounded-r-full hover:bg-green-700 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-green-700">
                            Sign Up
                        </button>
                    </span>
                </div>
